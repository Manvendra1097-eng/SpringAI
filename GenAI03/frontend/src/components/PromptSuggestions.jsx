...
export function PromptSuggestions({ onSelectPrompt }) {
  return (
    <div className="flex flex-col items-center justify-center my-auto py-10 px-4 max-w-3xl mx-auto text-center">
      ...
      <p className="text-sm sm:text-base text-gray-400 max-w-md mb-4 md:mb-8 leading-relaxed">
        Choose a prompt below or start typing.
      </p>

      {/* Suggestion Cards Grid */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 md:gap-3 w-full text-left">
        {SUGGESTED_PROMPTS.map((item) => {
          ...
          return (
            <button
              ...
              className="group p-3 md:p-4 rounded-xl bg-[#14171e] hover:bg-[#191d26] border border-[#222633] hover:border-emerald-500/40 transition-all duration-150 flex items-start gap-3.5 text-left cursor-pointer"
            >
